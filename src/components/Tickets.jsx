...
function Ticket(props) {
  ...
  return (
    <div
      className="flex-none shadow-xl shadow-blue-100  overflow-hidden relative flex flex-col h-[622px] bg-white w-[350px] rounded-[30px] mb-12 ">
      <div className="h-[50%] border-2 rounded-[20px]  w-full self-center rounded-t-[30px]">
        <img
          src={eventImg}
          alt="Event Image"
      ...
      <div className="h-[50%] ">
        <div className=" flex flex-row h-[25%] items-center  mx-auto">
          <div className="w-[38px]  rotate-180  overflow-hidden">
            <div className="shadow-inner  w-[75px] bg-zinc-100 h-[75px] rounded-[75px]"></div>
          </div>
        ...
        <div className="h-[75%]   border-t-0 rounded-b-[30px]">
          ...
          <h1 className="font-[900] text-left text-2xl  leading-tight">
            ...
            <p className=" font-[300] block text-md ">
              {eventDescription}
            </p></div>
            ...
            <div className="justify-center flex">
              {eventButton == 0 ? (
                ...
                <a className="text-center absolute bottom-5 text-md font-extrabold w-[151px] h-[60px]  shadow-md rounded-[30px] flex items-center justify-center"
                  rel="noreferrer"
                >
