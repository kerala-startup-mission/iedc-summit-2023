...
export const Engagementprograms = [
  {
    ...
    ticketDescription:
      "Join us as a volunteer for IEDC Summit 2023 and seize the opportunity to advance your career, build networks, and gain valuable skills. Apply now to be part of Asia's largest summit for student entrepreneurs!",
    ticketLink:
  ...
  },
  {
    ticketTitle: "Mentors",
    ticketDescription:
      "Passionate about showcasing leadership and fostering innovation? Join us as a Campus Ambassador for valuable leadership experience, certificates, and a chance to win ₹25,000 in rewards!",
    ticketLink:
